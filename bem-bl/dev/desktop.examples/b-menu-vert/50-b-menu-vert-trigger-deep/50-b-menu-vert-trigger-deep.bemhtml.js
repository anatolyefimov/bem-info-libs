        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1kctx = __$ctx.ctx, _$1kprops = [
                        'title',
                        'target'
                    ], _$1kp = typeof _$1kctx.url, _$1ka = { href: _$1kp === 'undefined' || _$1kp === 'string' ? _$1kctx.url : (_$1kp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1kp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1kctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1kp.join('')) };
