  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-icon' && $$mode === 'attrs') {
            {
                ...
                _$1pctx.url && (_$1pa.src = _$1pctx.url);
                while (_$1pp = _$1pprops.shift()) {
                    _$1pctx[_$1pp] && (_$1pa[_$1pp] = _$1pctx[_$1pp]);
                }
                return _$1pa;
            }
            return;
        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1hctx = __$ctx.ctx, _$1hprops = [
                        'title',
                        'target'
                    ], _$1hp = typeof _$1hctx.url, _$1ha = { href: _$1hp === 'undefined' || _$1hp === 'string' ? _$1hctx.url : (_$1hp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1hp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1hctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1hp.join('')) };
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'layout-unit' && $$mode === 'mix') {
            {
                var _$1dmix = [];
                __$ctx.isFirst() && _$1dmix.push({ elemMods: { position: 'first' } });
                __$ctx.isLast() && _$1dmix.push({ elemMods: { position: 'last' } });
                return _$1dmix;
            }
            return;
        }
