var BEMHTML = function() {
  ...
  var cache,
    ...
    function $11(__$ctx) {
        var _$1cctx = __$ctx.ctx, _$1ccontent = _$1cctx.content || _$1cctx.icon;
        _$1cctx.icon && (_$1cctx.icon.block = 'b-logo');
        if (__$ctx._.isArray(_$1cctx.content)) {
            for (var _$1cc in _$1cctx.content) {
                _$1cctx.content[_$1cc].elem && (_$1cctx.content[_$1cc].block = 'b-logo');
                _$1cctx.content[_$1cc].tag = 'span';
            }
        } else {
            undefined;
        }
        _$1cctx.block = 'b-link';
        _$1cctx.elem = undefined, _$1cctx.content = _$1ccontent, _$1cctx.mix = [{
                block: 'b-logo',
                elem: 'link'
            }];
        {
    ...
    function $28(__$ctx) {
        ...
        var _$mctx = __$ctx.ctx, _$mdtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $167(__$ctx), $$mode = __r0, '', __r1), _$mxUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $159(__$ctx), $$mode = __r2, '', __r3), _$mbuf = [
                _$mdtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $43(__$ctx) {
        ...
        if (_$fctx.content) {
            var _$fcnt;
            _$fparams.content = (_$fcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$fcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$fctx.content, __r3 = $184(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$fcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $56(__$ctx) {
        ...
        var _$19ctx = __$ctx.ctx, _$19props = [
                'title',
                'target'
            ], _$19p = typeof _$19ctx.url, _$19a = { href: _$19p === 'undefined' || _$19p === 'string' ? _$19ctx.url : (_$19p = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$19p, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$19ctx.url, __r3 = $184(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$19p.join('')) };
