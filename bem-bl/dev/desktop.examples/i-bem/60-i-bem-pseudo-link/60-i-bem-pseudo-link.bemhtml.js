        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1actx = __$ctx.ctx, _$1aprops = [
                        'title',
                        'target'
                    ], _$1ap = typeof _$1actx.url, _$1aa = { href: _$1ap === 'undefined' || _$1ap === 'string' ? _$1actx.url : (_$1ap = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1ap, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1actx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1ap.join('')) };
