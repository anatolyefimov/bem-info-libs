  ...
  var cache,
    ...
    function $5(__$ctx) {
        ...
        var _$1jctx = __$ctx.ctx, _$1jprops = [
                'title',
                'target'
            ], _$1jp = typeof _$1jctx.url, _$1ja = { href: _$1jp === 'undefined' || _$1jp === 'string' ? _$1jctx.url : (_$1jp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1jp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1jctx.url, __r3 = $235(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1jp.join('')) };
    ...
    function $123(__$ctx) {
        var __r0, __r1, __r2, __r3;
        var _$mctx = __$ctx.ctx, _$mdtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $228(__$ctx), $$mode = __r0, '', __r1), _$mxUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $220(__$ctx), $$mode = __r2, '', __r3), _$mbuf = [
                _$mdtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $138(__$ctx) {
        ...
        if (_$fctx.content) {
            var _$fcnt;
            _$fparams.content = (_$fcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$fcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$fctx.content, __r3 = $235(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$fcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $159(__$ctx) {
        ...
        if (__t === 'b-menu-horiz') {
            if ($$elem === 'layout-unit') {
                if (!$$mods === false) {
                    var _$1amix = [];
                    __$ctx.isFirst() && _$1amix.push({ elemMods: { position: 'first' } });
                    __$ctx.isLast() && _$1amix.push({ elemMods: { position: 'last' } });
                    return _$1amix;
                    return;
                } else {
                    return $174(__$ctx);
    ...
    function $255(__$ctx) {
        ...
        _$4tag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $27(__$ctx), $$mode = __r0, '', __r1);
...
/* begin: ../../../blocks-desktop/i-menu/i-menu.js */
/**
 * @module i-menu
 */
(function() {
...
/* end: ../../../blocks-desktop/i-menu/i-menu.js */
...
/* begin: ../../../blocks-desktop/b-menu-horiz/b-menu-horiz.js */
(function() {
...
/* end: ../../../blocks-desktop/b-menu-horiz/b-menu-horiz.js */