...
return r;
  ...
  var cache,
    ...
    function $2(__$ctx) {
        ...
        if (__t === 'b-layout-table') {
            if (!($$elem === 'cell' || $$elem === 'gap') === false) {
                var _$1bctx = __$ctx.ctx, _$1ba = {}, _$1bprops = [
                        'colspan',
                        'rowspan'
                    ], _$1bp;
    ...
    function $103(__$ctx) {
        ...
        var _$mctx = __$ctx.ctx, _$mdtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $150(__$ctx), $$mode = __r0, '', __r1), _$mxUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $142(__$ctx), $$mode = __r2, '', __r3), _$mbuf = [
                _$mdtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $118(__$ctx) {
        ...
        if (_$fctx.content) {
            var _$fcnt;
            _$fparams.content = (_$fcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$fcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$fctx.content, __r3 = $167(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$fcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $187(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $67(__$ctx), $$mode = __r6, '', __r7);
