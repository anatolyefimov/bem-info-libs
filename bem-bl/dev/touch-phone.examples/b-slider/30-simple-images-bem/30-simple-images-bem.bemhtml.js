var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-icon' && !__$ctx.ctx.url === false && $$mode === 'attrs') {
            {
        ...
        if (!!$$elem === false && $$block === 'b-icon' && !__$ctx.ctx.url === false && $$mode === 'tag') {
            return 'img';
            return;
        }
        ...
        if (!!$$elem === false && $$block === 'b-slider' && $$mode === 'content') {
            {
        ...
        if (!!$$elem === false && $$block === 'b-slider' && $$mode === 'mix') {
            {
                var _$1dmix = [];
        ...
        if (!!$$elem === false && $$block === 'b-slider' && $$mode === 'js') {
            return true;
            return;
        }
        if ($$block === 'b-menu' && $$elem === 'gap' && $$mode === 'tag') {
            return 'li';
            return;
        }
        if ($$block === 'b-menu' && $$elem === 'item' && !__$ctx.isLast() === false && $$mode === 'mix') {
            return [{ elemMods: { pos: 'last' } }];
            return;
        }
        if ($$block === 'b-menu' && $$elem === 'item' && !__$ctx.isFirst() === false && $$mode === 'mix') {
            return [{ elemMods: { pos: 'first' } }];
            return;
        }
        if ($$block === 'b-menu' && $$elem === 'item' && $$mode === 'tag') {
            return 'li';
            return;
        }
        if ($$block === 'b-menu' && $$elem === 'title' && $$mode === 'tag') {
            return 'h3';
            return;
        }
        if (!!$$elem === false && $$block === 'b-menu' && $$mode === 'content') {
            return [
