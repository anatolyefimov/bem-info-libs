var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$19ctx = __$ctx.ctx, _$19props = [
                        'title',
                        'target'
                    ], _$19p = typeof _$19ctx.url, _$19a = { href: _$19p === 'undefined' || _$19p === 'string' ? _$19ctx.url : (_$19p = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$19p, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$19ctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$19p.join('')) };
        ...
        if (!!$$elem === false && $$block === 'b-pseudo-link-example' && $$mode === 'js') {
            return true;
            return;
        }
