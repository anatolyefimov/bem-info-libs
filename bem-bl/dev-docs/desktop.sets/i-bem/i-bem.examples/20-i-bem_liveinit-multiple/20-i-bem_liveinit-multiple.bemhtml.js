var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (__$ctx.block === "b-tv" && __$ctx.elem === "over" && __$ctx._mode === "attrs") {
            return {
                type: "button",
                value: "Наводить"
            };
        ...
        if (__$ctx.block === "b-tv" && __$ctx.elem === "over" && __$ctx._mode === "tag") {
            return "input";
            return;
        }
        if (__$ctx.block === "b-tv" && __$ctx.elem === "click" && __$ctx._mode === "attrs") {
            return {
                type: "button",
                value: "Кликать"
            };
        ...
        if (__$ctx.block === "b-tv" && __$ctx.elem === "click" && __$ctx._mode === "tag") {
            return "input";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-tv" && __$ctx._mode === "js") {
            return true;
            return;
        }
