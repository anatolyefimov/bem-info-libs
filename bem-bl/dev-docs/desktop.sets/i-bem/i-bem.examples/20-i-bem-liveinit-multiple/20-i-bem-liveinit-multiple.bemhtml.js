var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if ($$block === 'b-tv' && $$elem === 'over' && $$mode === 'attrs') {
            return {
                type: 'button',
                value: '\u041D\u0430\u0432\u043E\u0434\u0438\u0442\u044C'
            };
        ...
        if ($$block === 'b-tv' && $$elem === 'over' && $$mode === 'tag') {
            return 'input';
            return;
        }
        if ($$block === 'b-tv' && $$elem === 'click' && $$mode === 'attrs') {
            return {
                type: 'button',
                value: '\u041A\u043B\u0438\u043A\u0430\u0442\u044C'
            };
        ...
        if ($$block === 'b-tv' && $$elem === 'click' && $$mode === 'tag') {
            return 'input';
            return;
        }
        if (!!$$elem === false && $$block === 'b-tv' && $$mode === 'js') {
            return true;
            return;
        }
