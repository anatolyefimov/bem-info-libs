var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-icon' && $$mode === 'attrs') {
            {
                ...
                _$1ectx.url && (_$1ea.src = _$1ectx.url);
        ...
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'complex') === false && !($$elem === 'layout-unit' || $$elem === 'separator' || $$elem === 'gap') === false && $$mode === 'tag') {
            return 'td';
            return;
        }
        if (!!$$elem === false && $$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'complex') === false && $$mode === 'content') {
            return [{
                    elem: 'layout',
                    tag: 'table',
                    content: {
