  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1ictx = __$ctx.ctx, _$1iprops = [
                        'title',
                        'target'
                    ], _$1ip = typeof _$1ictx.url, _$1ia = { href: _$1ip === 'undefined' || _$1ip === 'string' ? _$1ictx.url : (_$1ip = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1ip, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1ictx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1ip.join('')) };
        ...
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'simple') === false && $$elem === 'layout-unit' && $$mode === 'tag') {
            return false;
            return;
        }
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'simple') === false && $$elem === 'item' && $$mode === 'tag') {
            return $$elemMods.state ? 'span' : false;
            return;
        }
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'simple') === false && $$elem === 'item' && !(__$ctx['__$anflg5'] !== true) === false && $$mode === 'default') {
            return '', __r0 = __$ctx['__$anflg5'], __$ctx['__$anflg5'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = [
                __$ctx.isFirst() ? '' : __$ctx._separator,
                __$ctx.ctx
            ], __r2 = $$mode, $$mode = '', __r3 = applyc(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg5'] = __r0, '', __r4;
            return;
        }
        if (!!$$elem === false && $$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'simple') === false && $$mode === 'content') {
            return [
                __$ctx.ctx.title,
                {
                    tag: false,
        ...
        if (!!$$elem === false && $$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'simple') === false && !(__$ctx['__$anflg4'] !== true) === false && $$mode === 'default') {
            {
                {
                    '';
                    var __r0 = __$ctx['__$anflg4'];
                    __$ctx['__$anflg4'] = true;
                    {
                        '';
                        var __r1 = __$ctx._separator;
                        __$ctx._separator = __$ctx.ctx.separator;
                        applyc(__$ctx);
                        __$ctx._separator = __r1;
                        '';
                    }
                    __$ctx['__$anflg4'] = __r0;
                    '';
                }
                undefined;
            }
        ...
        if ($$block === 'b-menu-horiz' && $$elem === 'title' && $$mode === 'tag') {
            return 'h3';
            return;
        }
        if ($$block === 'b-menu-horiz' && !$$mods === false && $$elem === 'item-selector' && $$mode === 'tag') {
            return 'span';
            return;
        }
        if ($$block === 'b-menu-horiz' && !$$mods === false && $$elem === 'layout-unit' && $$mode === 'mix') {
            {
                var _$19mix = [];
                __$ctx.isFirst() && _$19mix.push({ elemMods: { position: 'first' } });
                __$ctx.isLast() && _$19mix.push({ elemMods: { position: 'last' } });
                return _$19mix;
            }
            return;
        }
        if ($$block === 'b-menu-horiz' && !$$mods === false && $$elem === 'item' && !(__$ctx['__$anflg3'] !== true) === false && $$mode === 'default') {
            {
                {
                    '';
        ...
        if (!!$$elem === false && $$block === 'b-menu-horiz' && !$$mods === false && $$mode === 'js') {
            return true;
            return;
        }
        ...
        if (!!$$elem === false && $$block === 'b-page' && !(__$ctx['__$anflg2'] !== true) === false && $$mode === 'default') {
            {
                var _$lctx = __$ctx.ctx, _$ldtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = applyc(__$ctx), $$mode = __r0, '', __r1), _$lxUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = applyc(__$ctx), $$mode = __r2, '', __r3), _$lbuf = [
                        _$ldtype,
                        {
                            elem: 'root',
                            content: [
