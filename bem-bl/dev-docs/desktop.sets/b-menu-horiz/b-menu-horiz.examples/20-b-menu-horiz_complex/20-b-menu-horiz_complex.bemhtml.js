var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!__$ctx.elem === false && __$ctx.block === "b-icon" && __$ctx._mode === "attrs") {
            {
                var _$1ectx = __$ctx.ctx, _$1ea = {
                    ...
                    alt: ""
                }, _$1eprops = [ "alt", "width", "height" ], _$1ep;
        ...
        if (__$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "complex") === false && !(__$ctx.elem === "layout-unit" || __$ctx.elem === "separator" || __$ctx.elem === "gap") === false && __$ctx._mode === "tag") {
            return "td";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "complex") === false && __$ctx._mode === "content") {
            return [ {
                elem: "layout",
                tag: "table",
                content: {
