var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if ($$block === 'b-link' && $$elem === 'inner' && $$mode === 'tag') {
            return 'span';
            return;
        }
        if ($$block === 'b-link' && !($$mods && $$mods.pseudo) === false && !!$$elem === false && $$mode === 'content' && !!__$ctx.ctx._wrap === false && !!$$mods.inner === false) {
            {
                {
                    '';
                    var __r0 = $$mode;
        ...
        if ($$block === 'b-link' && !($$mods && $$mods.pseudo) === false && !!$$elem === false && $$mode === 'attrs' && !!__$ctx.ctx.url === false) {
            return {};
            return;
        }
        if ($$block === 'b-link' && !($$mods && $$mods.pseudo) === false && !!$$elem === false && $$mode === 'js') {
            return true;
            return;
        }
        if ($$block === 'b-link' && !($$mods && $$mods.pseudo) === false && !!$$elem === false && $$mode === 'tag') {
            return __$ctx.ctx.url ? 'a' : 'span';
            return;
        }
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1gctx = __$ctx.ctx, _$1gprops = [
                        'title',
                        'target'
                    ], _$1gp = typeof _$1gctx.url, _$1ga = { href: _$1gp === 'undefined' || _$1gp === 'string' ? _$1gctx.url : (_$1gp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1gp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1gctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1gp.join('')) };
                while (_$1gp = _$1gprops.pop()) {
        ...
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'normal') === false && $$elem === 'layout-unit' && $$mode === 'tag') {
            return 'li';
            return;
        }
        if ($$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'normal') === false && $$elem === 'layout' && $$mode === 'tag') {
            return 'ul';
            return;
        }
        if (!!$$elem === false && $$block === 'b-menu-horiz' && !($$mods && $$mods.layout === 'normal') === false && $$mode === 'content') {
            return [
                __$ctx.ctx.title,
                {
                    elem: 'layout',
