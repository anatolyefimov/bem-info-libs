var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        var __r8, __r9, __r10, __r11, __r12, __r13, __r14, __r15, __r16, __r17, __r18, __r19, __r20, __r21, __r22, __r23, __r24, __r25, __r26, __r27, __r28, __r29, __r30, __r31, __r47, __r48, __r49, __r50, __r51, __r52, __r53, __r54, __r55, __r56, __r57, __r75, __r76, __r77, __r78, __r79, __r80, __r81, __r82, __r83;
        if (!!__$ctx.elem === false && __$ctx.block === "b-link" && __$ctx._mode === "attrs") {
            {
                var _$1ictx = __$ctx.ctx, _$1iprops = [ "title", "target" ], _$1ip = typeof _$1ictx.url, _$1ia = {
                    href: _$1ip === "undefined" || _$1ip === "string" ? _$1ictx.url : (_$1ip = [], "", __r80 = __$ctx._buf, __$ctx._buf = _$1ip, __r81 = __$ctx._mode, __$ctx._mode = "", __r82 = __$ctx.ctx, __$ctx.ctx = _$1ictx.url, __r83 = applyc(__$ctx), __$ctx._buf = __r80, __$ctx._mode = __r81, __$ctx.ctx = __r82, "", __r83, _$1ip.join(""))
                };
        ...
        if (__$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "simple") === false && __$ctx.elem === "layout-unit" && __$ctx._mode === "tag") {
            return false;
            return;
        }
        if (__$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "simple") === false && __$ctx.elem === "item" && __$ctx._mode === "tag") {
            return __$ctx.elemMods.state ? "span" : false;
            return;
        }
        if (__$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "simple") === false && __$ctx.elem === "item" && !(__$ctx["__$anflg5"] !== true) === false && __$ctx._mode === "default") {
            return "", __r75 = __$ctx["__$anflg5"], __$ctx["__$anflg5"] = true, __r79 = ("", __r76 = __$ctx.ctx, __$ctx.ctx = [ __$ctx.isFirst() ? "" : __$ctx._separator, __$ctx.ctx ], __r77 = __$ctx._mode, __$ctx._mode = "", __r78 = applyc(__$ctx), __$ctx.ctx = __r76, __$ctx._mode = __r77, "", __r78), __$ctx["__$anflg5"] = __r75, "", __r79;
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "simple") === false && __$ctx._mode === "content") {
        ...
        if (!!__$ctx.elem === false && __$ctx.block === "b-menu-horiz" && !(__$ctx.mods && __$ctx.mods.layout === "simple") === false && !(__$ctx["__$anflg4"] !== true) === false && __$ctx._mode === "default") {
            {
                {
                    "";
                    var __r73 = __$ctx["__$anflg4"];
                    __$ctx["__$anflg4"] = true;
                    {
                        "";
                        var __r74 = __$ctx._separator;
                        __$ctx._separator = __$ctx.ctx.separator;
                        applyc(__$ctx);
                        __$ctx._separator = __r74;
                        "";
                    }
                    __$ctx["__$anflg4"] = __r73;
                    "";
                }
                undefined;
            }
        ...
        if (__$ctx.block === "b-menu-horiz" && __$ctx.elem === "title" && __$ctx._mode === "tag") {
            return "h3";
            return;
        }
        if (__$ctx.block === "b-menu-horiz" && !__$ctx.mods === false && __$ctx.elem === "item-selector" && __$ctx._mode === "tag") {
            return "span";
            return;
        }
        if (__$ctx.block === "b-menu-horiz" && !__$ctx.mods === false && __$ctx.elem === "layout-unit" && __$ctx._mode === "mix") {
            {
                var _$19mix = [];
                __$ctx.isFirst() && _$19mix.push({
                    elemMods: {
                        position: "first"
                    }
                });
                __$ctx.isLast() && _$19mix.push({
                    elemMods: {
                        position: "last"
                    }
                });
        ...
        if (__$ctx.block === "b-menu-horiz" && !__$ctx.mods === false && __$ctx.elem === "item" && !(__$ctx["__$anflg3"] !== true) === false && __$ctx._mode === "default") {
            {
                {
                    "";
                    ...
                    __$ctx["__$anflg3"] = true;
                    {
                        ...
                        __$ctx._mode = "";
                        var __r71 = __$ctx.position;
                        __$ctx.position = __$ctx.position - 1;
                        var __r72 = __$ctx.ctx;
                        __$ctx.ctx = {
                            elem: "layout-unit",
                            content: __$ctx.ctx
                        };
        ...
        if (!!__$ctx.elem === false && __$ctx.block === "b-menu-horiz" && !__$ctx.mods === false && __$ctx._mode === "js") {
            return true;
            return;
        }
