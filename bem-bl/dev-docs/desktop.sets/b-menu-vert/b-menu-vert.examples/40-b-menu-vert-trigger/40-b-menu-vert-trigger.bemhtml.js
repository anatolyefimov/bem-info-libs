var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'separator' && $$mode === 'tag') {
            return 'li';
            return;
        }
        if (!!$$elem === false && $$block === 'b-icon' && $$mode === 'attrs') {
            {
        ...
        if (!!$$elem === false && $$block === 'b-icon' && $$mode === 'tag') {
            return 'img';
            return;
        }
        if ($$block === 'b-menu-vert' && $$elem === 'trigger' && $$mode === 'tag') {
            return 'span';
            return;
        }
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'submenu' && $$mode === 'tag') {
            return 'ul';
            return;
        }
        if ($$block === 'b-menu-vert' && $$elem === 'item-selector' && $$mode === 'tag') {
            return 'span';
            return;
        }
        if ($$block === 'b-menu-vert' && $$elem === 'layout-unit' && $$mode === 'mix') {
            {
                var _$1cmix = [];
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'layout-unit' && $$mode === 'tag') {
            return 'li';
            return;
        }
        if ($$block === 'b-menu-vert' && $$elem === 'item' && !(__$ctx['__$anflg3'] !== true) === false && $$mode === 'default') {
            {
                {
                    '';
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'layout' && $$mode === 'tag') {
            return 'ul';
            return;
        }
        if (!!$$elem === false && $$block === 'b-menu-vert' && $$mode === 'content') {
            return [
                __$ctx.ctx.title,
                {
                    elem: 'layout',
        ...
        if ($$block === 'b-menu-vert' && $$elem === 'title' && $$mode === 'tag') {
            return 'h3';
            return;
        }
