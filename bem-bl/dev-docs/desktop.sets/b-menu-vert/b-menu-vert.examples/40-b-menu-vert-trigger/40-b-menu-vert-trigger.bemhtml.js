var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "separator" && __$ctx._mode === "tag") {
            return "li";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-icon" && __$ctx._mode === "attrs") {
            {
                var _$1octx = __$ctx.ctx, _$1oa = {
                    ...
                    alt: ""
                }, _$1oprops = [ "alt", "width", "height" ], _$1op;
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "trigger" && __$ctx._mode === "tag") {
            return "span";
            return;
        }
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "submenu" && __$ctx._mode === "tag") {
            return "ul";
            return;
        }
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "item-selector" && __$ctx._mode === "tag") {
            return "span";
            return;
        }
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "layout-unit" && __$ctx._mode === "mix") {
            {
                var _$1cmix = [];
                __$ctx.isFirst() && _$1cmix.push({
                    elemMods: {
                        position: "first"
                    }
                });
                __$ctx.isLast() && _$1cmix.push({
                    elemMods: {
                        position: "last"
                    }
                });
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "layout-unit" && __$ctx._mode === "tag") {
            return "li";
            return;
        }
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "item" && !(__$ctx["__$anflg3"] !== true) === false && __$ctx._mode === "default") {
            {
                {
                    "";
                    ...
                    __$ctx["__$anflg3"] = true;
                    {
                        ...
                        __$ctx.ctx = {
                            elem: "layout-unit",
                            content: [ __$ctx.ctx, __$ctx.ctx["item-content"] ]
                        };
                        applyc(__$ctx);
                        __$ctx._mode = __r70;
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "layout" && __$ctx._mode === "tag") {
            return "ul";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-menu-vert" && __$ctx._mode === "content") {
        ...
        if (__$ctx.block === "b-menu-vert" && __$ctx.elem === "title" && __$ctx._mode === "tag") {
            return "h3";
            return;
        }
