  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1jctx = __$ctx.ctx, _$1jprops = [
                        'title',
                        'target'
                    ], _$1jp = typeof _$1jctx.url, _$1ja = { href: _$1jp === 'undefined' || _$1jp === 'string' ? _$1jctx.url : (_$1jp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1jp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1jctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1jp.join('')) };
        ...
        if (!!$$elem === false && $$block === 'b-icon' && $$mode === 'attrs') {
            {
                ...
                _$1hctx.url && (_$1ha.src = _$1hctx.url);
