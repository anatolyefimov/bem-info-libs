var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if ($$block === 'b-layout-table' && !($$elem === 'cell' || $$elem === 'gap') === false && $$mode === 'attrs') {
            {
                var _$1ictx = __$ctx.ctx, _$1ia = {}, _$1iprops = [
                        'colspan',
                        'rowspan'
                    ], _$1ip;
                while (_$1ip = _$1iprops.shift()) {
        ...
        if ($$block === 'b-layout-table' && !($$elem === 'cell' || $$elem === 'gap') === false && $$mode === 'tag') {
            return 'td';
            return;
        }
        if ($$block === 'b-layout-table' && $$elem === 'row' && $$mode === 'tag') {
            return 'tr';
            return;
        }
        if (!!$$elem === false && $$block === 'b-layout-table' && $$mode === 'tag') {
            return 'table';
            return;
        }
        if ($$block === 'b-search' && $$elem === 'button' && $$mode === 'attrs') {
            return {
                type: 'submit',
                value: 'Search'
            };
        ...
        if ($$block === 'b-search' && $$elem === 'button' && $$mode === 'tag') {
            return 'input';
            return;
        }
        if ($$block === 'b-search' && $$elem === 'input' && $$mode === 'attrs') {
            return { name: 'text' };
            return;
        }
        if ($$block === 'b-search' && $$elem === 'input' && $$mode === 'tag') {
            return 'input';
            return;
        }
        if (!!$$elem === false && $$block === 'b-search' && $$mode === 'content' && !__$ctx.ctx.input === false && !__$ctx.ctx.button === false) {
            {
                ...
                __$ctx.ctx.under && _$1ac.content.push({
                    elem: 'row',
                    content: [{
                            elem: 'cell',
                            mix: [{
        ...
        if (!!$$elem === false && $$block === 'b-search' && $$mode === 'tag') {
            return 'form';
            return;
        }
