var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        var __r8, __r9, __r10, __r11, __r12, __r13, __r14, __r15, __r16, __r17, __r18, __r19, __r20, __r21, __r22, __r23, __r24, __r25, __r26, __r27, __r28, __r29, __r30, __r31, __r47, __r48, __r49, __r50, __r51, __r52, __r53, __r54, __r55, __r56, __r57;
        if (__$ctx.block === "b-layout-table" && !(__$ctx.elem === "cell" || __$ctx.elem === "gap") === false && __$ctx._mode === "attrs") {
            {
                var _$1gctx = __$ctx.ctx, _$1ga = {}, _$1gprops = [ "colspan", "rowspan" ], _$1gp;
        ...
        if (__$ctx.block === "b-layout-table" && !(__$ctx.elem === "cell" || __$ctx.elem === "gap") === false && __$ctx._mode === "tag") {
            return "td";
            return;
        }
        if (__$ctx.block === "b-layout-table" && __$ctx.elem === "row" && __$ctx._mode === "tag") {
            return "tr";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-layout-table" && __$ctx._mode === "tag") {
            return "table";
            return;
        }
        if (__$ctx.block === "b-search" && __$ctx.elem === "button" && __$ctx._mode === "attrs") {
            return {
                type: "submit",
                value: "Search"
            };
        ...
        if (__$ctx.block === "b-search" && __$ctx.elem === "button" && __$ctx._mode === "tag") {
            return "input";
            return;
        }
        if (__$ctx.block === "b-search" && __$ctx.elem === "input" && __$ctx._mode === "attrs") {
            return {
                name: "text"
            };
            return;
        }
        if (__$ctx.block === "b-search" && __$ctx.elem === "input" && __$ctx._mode === "tag") {
            return "input";
            return;
        }
        if (!!__$ctx.elem === false && __$ctx.block === "b-search" && __$ctx._mode === "content" && !__$ctx.ctx.input === false && !__$ctx.ctx.button === false) {
            {
        ...
        if (!!__$ctx.elem === false && __$ctx.block === "b-search" && __$ctx._mode === "tag") {
            return "form";
            return;
        }
