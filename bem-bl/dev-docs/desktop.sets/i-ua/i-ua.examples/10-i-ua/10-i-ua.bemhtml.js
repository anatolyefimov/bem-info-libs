var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        var __this = __$ctx;
        var __r0, __r1, __r2, __r3, __r4, __r5, __r6, __r7, __r8, __r9, __r10, __r11, __r12, __r13, __r14, __r15, __r16, __r17, __r18, __r19, __r20, __r21, __r22, __r23;
        if ($$block === 'checkbox' && $$elem === 'control' && $$mode === 'attrs') {
            {
                var _$1ka = __$ctx.ctx.attrs || {};
                _$1ka.id = __$ctx._checkboxAttrs.id;
                _$1ka.type = 'checkbox';
                $$mods.disabled && (_$1ka.disabled = 'disabled');
                $$mods.checked == 'yes' && (_$1ka.checked = 'checked');
                _$1ka['aria-labelledby'] = __$ctx._labelId;
                return _$1ka;
            }
            return;
        }
        if ($$block === 'checkbox' && $$elem === 'control' && $$mode === 'tag') {
            return 'input';
            return;
        }
        if (!!$$elem === false && $$block === 'checkbox' && $$mode === 'content') {
            return [
                {
                    elem: 'box',
                    tag: 'span',
        ...
        if (!!$$elem === false && $$block === 'checkbox' && $$mode === 'default' && !(__$ctx['__$anflg5'] !== true) === false && !!__$ctx._checkboxAttrs === false) {
            {
                var _$1hcheckboxId = (__$ctx.ctx.checkboxAttrs || {}).id, _$1hid = _$1hcheckboxId || __$ctx.generateId();
                {
                    ...
                    __$ctx['__$anflg5'] = true;
                    {
                        ...
                        __$ctx._checkboxAttrs = _$1hcheckboxId ? __$ctx.ctx.checkboxAttrs : { id: 'id' + _$1hid };
        ...
        if (!!$$elem === false && $$block === 'checkbox' && $$mode === 'js') {
            return true;
            return;
        }
        if (!!$$elem === false && $$block === 'checkbox' && $$mode === 'tag') {
            return 'span';
            return;
        }
        if (!!$$elem === false && $$block === 'button' && !(__$ctx['__$anflg4'] !== true) === false && $$mode === 'content') {
            return {
                elem: 'text',
                tag: 'span',
                content: ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = applyc(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1)
            };
            return;
        }
        if (!!$$elem === false && $$block === 'button' && $$mode === 'tag') {
            return 'button';
            return;
        }
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'attrs') {
            {
                var _$1cctx = __$ctx.ctx, _$1cprops = [
                        'title',
                        'target'
                    ], _$1cp = typeof _$1cctx.url, _$1ca = { href: _$1cp === 'undefined' || _$1cp === 'string' ? _$1cctx.url : (_$1cp = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$1cp, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$1cctx.url, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$1cp.join('')) };
        ...
        if (!!$$elem === false && $$block === 'b-link' && $$mode === 'tag') {
            return 'a';
            return;
        }
        if ($$block === 'b-text' && !$$elem === false && !__$ctx.ctx.id === false && $$mode === 'attrs') {
            return { id: __$ctx.ctx.id };
            return;
        }
        if ($$block === 'b-text' && !$$elem === false && $$mode === 'tag') {
        ...
        if ($$block === 'b-page' && $$elem === 'css' && $$mode === 'default' && !__$ctx.ctx.hasOwnProperty('ie') === false && !!__$ctx.ctx._ieCommented === false) {
            {
        ...
        if (!!$$elem === false && $$block === 'b-page' && !(__$ctx['__$anflg3'] !== true) === false && $$mode === 'mix') {
            {
                var _$10mix = ('', __r0 = __$ctx['__$anflg3'], __$ctx['__$anflg3'] = true, __r1 = applyc(__$ctx), __$ctx['__$anflg3'] = __r0, '', __r1) || [];
                _$10mix.push({
                    block: 'i-ua',
        ...
        if ($$block === 'b-page' && $$elem === 'favicon' && $$mode === 'attrs') {
            return {
                rel: 'shortcut icon',
                href: __$ctx.ctx.url
            };
        ...
        if ($$block === 'b-page' && $$elem === 'favicon' && $$mode === 'tag') {
            return 'link';
            return;
        }
        if ($$block === 'b-page' && $$elem === 'favicon' && $$mode === 'bem') {
            return false;
            return;
        }
        ...
        if (!!$$elem === false && $$block === 'b-page' && $$mode === 'mix') {
            return [{ elem: 'body' }];
            return;
        }
        if (!!$$elem === false && $$block === 'b-page' && $$mode === 'tag') {
            return 'body';
            return;
        }
        if (!!$$elem === false && $$block === 'b-page' && !(__$ctx['__$anflg2'] !== true) === false && $$mode === 'default') {
            {
                var _$mctx = __$ctx.ctx, _$mdtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = applyc(__$ctx), $$mode = __r0, '', __r1), _$mxUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = applyc(__$ctx), $$mode = __r2, '', __r3), _$mbuf = [
                        _$mdtype,
                        {
                            elem: 'root',
                            content: [
        ...
        if (!!$$elem === false && $$block === 'b-page' && $$mode === 'xUACompatible') {
        ...
        if (!!$$elem === false && $$block === 'b-page' && $$mode === 'doctype') {
        ...
        if ($$block === 'i-bem' && $$elem === 'i18n' && $$mode === 'default') {
            {
                ...
                if (_$jctx.content) {
                    var _$jcnt;
                    _$jparams.content = (_$jcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$jcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$jctx.content, __r3 = applyc(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$jcnt.join(''));
                } else {
                    undefined;
                }
        ...
        if ($$mode === 'default') {
            {
                ...
                if (_$4tag) {
                            ...
                            if (_$4mix) {
                                ...
                                for (var _$4i = 0; _$4i < _$4mix.length; _$4i++) {
                                    ...
                                    if (_$4hasItem && !_$4visited[_$4visitedKey(_$4block, _$4elem)]) {
                                        ...
                                        var _$4nestedMix = ('', __r12 = $$block, $$block = _$4block, __r13 = $$elem, $$elem = _$4elem, __r14 = $$mode, $$mode = 'mix', __r15 = applyc(__$ctx), $$block = __r12, $$elem = __r13, $$mode = __r14, '', __r15);
                                        if (_$4nestedMix) {
                    ...
                    if (_$4jsParams) {
                        var _$4jsAttr = ('', __r18 = $$mode, $$mode = 'jsAttr', __r19 = applyc(__$ctx), $$mode = __r18, '', __r19);
                        _$4buf.push(' ', _$4jsAttr || 'onclick', '="return ', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
                    } else {
                        undefined;
                    }
                    var _$4attrs = ('', __r20 = $$mode, $$mode = 'attrs', __r21 = applyc(__$ctx), $$mode = __r20, '', __r21);
                ...
                if (__$ctx._.isShortTag(_$4tag)) {
                    ...
                    _$4tag && _$4buf.push('>');
                    var _$4content = ('', __r22 = $$mode, $$mode = 'content', __r23 = applyc(__$ctx), $$mode = __r22, '', __r23);
