var BEMHTML = function() {
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if (__$ctx.block === "b-logo" && __$ctx.elem === "icon" && !(__$ctx["__$anflg4"] !== true) === false && __$ctx._mode === "default") {
            {
                {
                    "";
                    var __r76 = __$ctx["__$anflg4"];
                    __$ctx["__$anflg4"] = true;
                    {
                        "";
                        var __r77 = __$ctx._mode;
                        __$ctx._mode = "";
                        var __r78 = __$ctx.ctx, __r79 = __r78.elem;
                        __r78.elem = undefined;
                        var __r80 = __$ctx.ctx, __r81 = __r80.block;
                        __r80.block = "b-icon";
                        var __r82 = __$ctx.ctx, __r83 = __r82.mix;
                        __r82.mix = [ {
                            block: "b-logo",
                            elem: "icon"
                        } ];
        ...
        if (__$ctx.block === "b-logo" && __$ctx.elem === "link" && !(__$ctx["__$anflg3"] !== true) === false && __$ctx._mode === "default") {
            {
        ...
        if (!!__$ctx.elem === false && __$ctx.block === "b-icon" && __$ctx._mode === "attrs") {
            {
                var _$1actx = __$ctx.ctx, _$1aa = {
                    ...
                    alt: ""
                }, _$1aprops = [ "alt", "width", "height" ], _$1ap;
