...
function __$b5(__$ctx, __$ref) {
    var ctx__$21 = __$ctx.ctx, attrs__$22 = {
        type: "radio",
        autocomplete: "off",
        name: ctx__$21.name,
        value: ctx__$21.val
    };
    ctx__$21.checked && (attrs__$22.checked = "checked");
    ctx__$21.disabled && (attrs__$22.disabled = "disabled");
    return attrs__$22;
}
...
function __$b31(__$ctx, __$ref) {
    var mods__$24 = $$mods, ctx__$25 = __$ctx.ctx, isValDef__$26 = typeof ctx__$25.val !== "undefined";
    return (ctx__$25.options || []).map(function(option, i) {
        return [ !!i && !mods__$24.type && {
            tag: "br"
        }, {
            block: "radio",
            mods: {
                ...
                size: mods__$24.size,
                checked: isValDef__$26 && ctx__$25.val === option.val,
                disabled: option.disabled || mods__$24.disabled
            },
            name: ctx__$25.name,
            val: option.val,
            text: option.text,
