...
/* begin: /home/tavria/bem-data-source/content/bem-components/v2/common.blocks/input/_type/input_type_password.bemhtml */
block('input').mod('type', 'password').elem('control').attrs()(function() {
    return this.extend(applyNext(), { type : 'password' });
});

/* end: /home/tavria/bem-data-source/content/bem-components/v2/common.blocks/input/_type/input_type_password.bemhtml */;
/// -------------------------------------
