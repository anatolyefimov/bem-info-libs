...
/* begin: /home/tavria/bem-data-source/content/bem-components/v2/common.blocks/input/_type/input_type_search.bemhtml */
block('input').mod('type', 'search').elem('control').attrs()(function() {
    return this.extend(applyNext(), { type : 'search' });
});

/* end: /home/tavria/bem-data-source/content/bem-components/v2/common.blocks/input/_type/input_type_search.bemhtml */
