...
/* begin: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_type/input_type_textarea.bemhtml */
block('input').mod('type', 'textarea').tag()('div');

block('input').mod('type', 'textarea').elem('box').tag()(false);

block('input').mod('type', 'textarea').def()(function() {
    this.mods['has-clear'] = false;
    applyNext();
});
...
/* end: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_type/input_type_textarea.bemhtml */
/* begin: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_has-clear/input_has-clear.bemhtml */
block('input').mod('has-clear', true).elem('box')
    .content()(function() {
        return [this.ctx.content, { elem : 'clear' }];
    });

/* end: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_has-clear/input_has-clear.bemhtml */
/* begin: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/__clear/input__clear.bemhtml */
block('input').elem('clear').tag()('i');

/* end: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/__clear/input__clear.bemhtml */
/* begin: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_type/input_type_password.bemhtml */
block('input').mod('type', 'password').elem('control').attrs()(function() {
    return this.extend(applyNext(), { type : 'password' });
});

/* end: /home/tavria/sites/bem-data-source-new/content/bem-components/v2/common.blocks/input/_type/input_type_password.bemhtml */;
/// -------------------------------------
