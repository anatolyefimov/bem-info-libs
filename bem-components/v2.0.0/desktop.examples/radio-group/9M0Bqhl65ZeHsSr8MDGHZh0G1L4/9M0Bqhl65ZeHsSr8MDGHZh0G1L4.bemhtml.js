...
function __$b5(__$ctx, __$ref) {
    var mods__$16 = $$mods, ctx__$17 = __$ctx.ctx, isValDef__$18 = typeof ctx__$17.val !== "undefined";
    return (ctx__$17.options || []).map(function(option, i) {
        return [ !!i && !mods__$16.type && {
            tag: "br"
        }, {
            block: "radio",
            mods: {
                type: mods__$16.type,
                mode: mods__$16.mode,
                theme: mods__$16.theme,
                size: mods__$16.size,
                checked: isValDef__$18 && ctx__$17.val === option.val,
                disabled: option.disabled || mods__$16.disabled
            },
            name: ctx__$17.name,
            val: option.val,
            text: option.text,
