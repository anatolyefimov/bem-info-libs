...
function __$b29(__$ctx, __$ref) {
    var ctx__$18 = __$ctx.ctx, button__$19 = ctx__$18.button;
    __$ctx.isSimple(button__$19) && (button__$19 = {
        block: "button",
        tag: "span",
        text: button__$19
    });
    var attachMods__$20 = $$mods, buttonMods__$21 = button__$19.mods || (button__$19.mods = {});
    [ "size", "theme", "disabled", "focused" ].forEach(function(mod) {
        buttonMods__$21[mod] || (buttonMods__$21[mod] = attachMods__$20[mod]);
    });
    return [ button__$19, {
        elem: "no-file",
...
function __$b46(__$ctx, __$ref) {
    ...
    __$r__$23 = __$r__$26;
    __$ctx._attach = __$l0__$24;
    return;
}

function __$b47(__$ctx, __$ref) {
    if (!__$ctx.ctx) return "";
    var ctx__$28 = __$ctx.ctx, keyset__$29 = ctx__$28.keyset, key__$30 = ctx__$28.key, params__$31 = ctx__$28.params || {};
    if (!(keyset__$29 || key__$30)) return "";
    if (typeof ctx__$28.content === "undefined" || ctx__$28.content !== null) {
        params__$31.content = exports.apply(ctx__$28.content);
    }
    __$ctx._buf.push(BEM.I18N(keyset__$29, key__$30, params__$31));
    return;
}
